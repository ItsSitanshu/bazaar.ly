    ...
    return (
        ...
        <div className="flex flex-row justify-start w-10/12 h-5/6 bg-stone-950 rounded-3xl">
            ...
            <div className="w-9/12 flex flex-col items-center justify-start pt-16">
                <h1 className="text-white font-cutive text-xl">Register an Account</h1>
                <p className="text-white/[.5] font-work text-sm">Complete these easy steps to get started in no time</p>
                <AuthButton/>
                <AuthForm/>
            </div>
            </div>
